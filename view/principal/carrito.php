...
// Si no hay carrito, redirigir al catálogo de productos
if (!$carrito) {
...
<body>
    <main class="container">
        ...
        <a href="index.php" role="button"><i class="ph ph-arrow-left"></i> Volver al catálogo</a>
        ...
        <?php if (count($productos_en_carrito) > 0): ?>
                ...
                <?php foreach ($productos_en_carrito as $producto): ?>
                    <div class="producto-tarjeta">
                        <div class="producto-imagen">
                            <img src="<?= htmlspecialchars($producto['imagen_url']) ?>" alt="<?= htmlspecialchars($producto['nombre']) ?>" class="imagen-producto">
                        </div>
                        <div class="producto-info">
                            ...
                            <p>Cantidad: 
                                <form action="../../controller/carrito/actualizar.php" method="POST">
                                    <input type="number" name="cantidad" value="<?= $producto['cantidad'] ?>" min="1" max="100" required>
                            ...
                            <a href="../../controller/carrito/eliminar.php?producto_id=<?= $producto['id'] ?>&carrito_id=<?= $carrito['id'] ?>" class="btn-eliminar">Eliminar</a>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
            <div class="total-carrito">
                ...
                <a href="procesar_pago.php?carrito_id=<?= $carrito['id'] ?>" class="btn-pagar">Pagar</a>
            </div>
        <?php else: ?>
